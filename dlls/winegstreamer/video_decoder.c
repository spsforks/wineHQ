...
static HRESULT WINAPI unknown_QueryInterface(IUnknown *iface, REFIID iid, void **out)
{
    ...
    else if (IsEqualGUID(iid, &IID_IMFTransform) && decoder->IMFTransform_iface.lpVtbl)
...
HRESULT h264_decoder_create(REFIID riid, void **out)
{
    ...
    if (FAILED(hr = IMFAttributes_SetUINT32(decoder->attributes, &MF_LOW_LATENCY, 0))
            ...
            || FAILED(hr = IMFAttributes_SetUINT32(decoder->attributes, &AVDecVideoAcceleration_H264, TRUE)))
    {
...
HRESULT wmv_decoder_create(IUnknown *outer, IUnknown **out)
{
    ...
    TRACE("Created wmv media object %p.\n", &decoder->IMediaObject_iface);
