...
static UINT nulldrv_VulkanInit( UINT version, void *vulkan_handle, struct vulkan_driver_funcs *driver_funcs )
{
...
static UINT loaderdrv_VulkanInit( UINT version, void *vulkan_handle, struct vulkan_driver_funcs *driver_funcs )
{
