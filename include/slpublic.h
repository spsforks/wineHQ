...
SLCAPI HRESULT WINAPI SLGetSLIDList(HSLC, UINT, const SLID *, UINT, UINT *, SLID **);
...
SLCAPI HRESULT WINAPI SLClose(HSLC);
SLCAPI HRESULT WINAPI SLPersistApplicationPolicies(const SLID *, const SLID *, DWORD);
