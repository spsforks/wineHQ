...
C_ASSERT( FIELD_OFFSET(struct load_registry_request, flags) == 12 );
C_ASSERT( FIELD_OFFSET(struct load_registry_request, access) == 16 );
C_ASSERT( sizeof(struct load_registry_request) == 24 );
C_ASSERT( FIELD_OFFSET(struct load_registry_reply, hkey) == 8 );
C_ASSERT( sizeof(struct load_registry_reply) == 16 );
